...
import '../assets/styles/CarLoader.css';
      ...
      <div className="loader">
        <svg className="car" width="102" height="40" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            ...
            />
            <circle
              className="car__wheel car__wheel--left"
              strokeWidth="3.2"
              fill="#FFF"
              cx="83.493"
              cy="30.25"
            ...
            />
            <circle
              className="car__wheel car__wheel--right"
              strokeWidth="3.2"
              fill="#FFF"
              cx="46.511"
              cy="30.25"
        ...
        <p className="loader-text">Renting your ride...</p>
      </div>
    </div>
  );
};
